...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) Es demasiado pequeño y debe ser mayor que <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>)Excede el tamaño máximo de subida permitido de<b>{maxSize} KB</b>.',
        ...
        msgInvalidFileType: 'Tipo de archivo no válido "{name}".Solamente "{types}" Archivos son compatibles.',
        msgInvalidFileExtension: 'Extensión no válida para el archivo"{name}".Solamente "{extensions}" Archivos Compatibles.',
        msgUploadAborted: 'Se ha anulado la subida del archivo.',
        ...
        msgSelected: '{n} {files} seleccionarr',
        msgFoldersNotAllowed: 'Sólo arrastrar y soltar archivos! {n} Carpeta(s) Se ha omitido la.',
        ...
        msgImageResizeError: 'CNo conseguir las dimensiones de la imagen para cambiar el tamaño.',
        msgImageResizeException: 'Error al cambiar el tamaño de la imagen.<pre>{errors}</pre>',
        dropZoneTitle: 'Arrastre aqui las imgenes que deseas cargar &hellip;',
        dropZoneClickTitle: '<br>( has click para seleccionar )',
